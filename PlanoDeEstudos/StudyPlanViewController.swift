...
import UIKit
import UserNotifications //framework para utilizar notificacoes
...
class StudyPlanViewController: UIViewController {
    ...
    @IBAction func schedule(_ sender: UIButton) {
        ...
        //sons de cada notificacao
        // este arquivo deve estar no projeto
        //content.sound = UNNotificationSound(named: "arquivodesom.caf")
        
        // categoria da notificacao
        content.categoryIdentifier = "Lembrete"
        
        //momento que a notificacao será exibida - trigger
